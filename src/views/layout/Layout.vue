                    ...
                    <el-col :span="10">
                        <el-menu @select="selectTopbar" :default-active="topbar.active" mode="horizontal" menu-trigger="click">
                            <el-submenu index="#more">
                                ...
                                <el-menu-item index="#csdn">csdn主页</el-menu-item>
...
<!--                        </audio>-->
                    ...
                    <el-col :span="4" style="text-align: right;">
                        ...
                        <div style="color:#606266;">
                            <i class="el-icon-location"></i>&nbsp;{{location?location:'CN'}}
                            <br>
                        </div>
                    </el-col>
            ...
            selectTopbar(index) {
                ...
                switch (index) {
                    case "#githubHome":
                        ...
                        break
                    case "#csdn":
                        window.open('https://blog.csdn.net/2301_76723816?spm=1000.2115.3001.5343' + this.githubUsername)
                        break
                    case "#blog":
                        if (this.blog) {
